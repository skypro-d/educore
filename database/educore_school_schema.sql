...
CREATE TABLE `school_settings` (
  ...
  `currency` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'NGN',
  `timezone` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT 'Africa/Lagos',
  `principal_name` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vice_principal` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `website` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `domain` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `academic_session` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '2024/2025',
  `term` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'First',
...
INSERT INTO `school_settings` (`id`, `school_name`, `school_code`, `motto`, `logo`, `email`, `phone`, `address`, `city`, `state`, `country`, `currency`, `timezone`, `principal_name`, `vice_principal`, `website`, `domain`, `academic_session`, `term`) VALUES
(1, 'EduCore Demonstration School', 'SCH-001', 'Excellence and Innovation', 'assets/img/logo.png', 'info@school.test', '+234 800 000 0000', '1 School Way', 'Lagos', 'Lagos', 'Nigeria', 'NGN', 'Africa/Lagos', 'Dr. Principal', 'Vice Principal', 'https://school.test', 'school.test', '2024/2025', 'First');
UNLOCK TABLES;
...
CREATE TABLE `admins` (
  ...
  `role` enum('system_admin','admin','admission_officer','accountant','principal','staff') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'admin',
...
INSERT INTO `admins` VALUES (1,1,'Portal Administrator','admin@school.test','$2y$10$WV4O4S0SKhteP8SVnsMt/OUbA6xKEJF2Wc1lypIrUYk6KeyATSUaW','system_admin','2026-06-03 22:56:07');
...
INSERT INTO `roles` VALUES (1,'system_admin','Full access to all system features'),(2,'admission_officer','Manage applications, exams, interviews, and admission decisions'),(3,'accountant','Manage payments, receipts, and revenue reports'),(4,'principal','View applications and reports'),(5,'staff','Limited application access');
...
CREATE TABLE `sms_logs` (
  ...
  `exit_log_id` int unsigned DEFAULT NULL COMMENT 'Reference to student_exit_logs row',
...
--
-- Table structure for table `school_gates`
--
DROP TABLE IF EXISTS `school_gates`;
CREATE TABLE IF NOT EXISTS `school_gates` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `school_id` int unsigned NOT NULL DEFAULT '1',
  `gate_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `gate_code` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `student_authorized_pickups`
--
...
CREATE TABLE IF NOT EXISTS `student_authorized_pickups` (
  ...
  `phone` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_card_number` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `student_exit_logs` (
  ...
  `pickup_person_name` varchar(140) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `exit_type` enum('normal','early','manual') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
  `exit_reason` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `exit_reason_notes` text COLLATE utf8mb4_unicode_ci,
  ...
  `scanned_by_name` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `scan_method` enum('qr_camera','qr_usb','manual','api_device') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'qr_usb',
  `qr_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verification_status` enum('verified','flagged','manual_override') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'verified',
  `sms_status` enum('sent','failed','pending','skipped') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
--
-- Table structure for table `system_update_history`
--
CREATE TABLE IF NOT EXISTS `system_update_history` (
  ...
  `status` enum('started','completed','rolled_back','failed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'started',
  `backup_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `backup_size_bytes` bigint unsigned DEFAULT NULL,
  `executed_migrations` text COLLATE utf8mb4_unicode_ci,
  `log_summary` text COLLATE utf8mb4_unicode_ci,
  `initiated_by` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT 'system_admin',
