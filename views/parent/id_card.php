<?php
/**
 * views/parent/id_card.php
 * Parent Portal — Dynamic Themed Student ID Card
 */
...
<div class="d-flex justify-content-between align-items-center no-print">
    ...
    <button onclick="window.print()" class="btn btn-primary"><i class="ti ti-printer" style="margin-right:6px"></i>Print ID Card</button>
</div>
    ...
    <div class="id-card">
        <div class="id-card-header-bg">
            <svg class="id-header-wave" viewBox="0 0 330 195" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="blueWaveGradParent" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <path d="M 0,0 L 210,0 C 170,70 110,120 0,165 Z" fill="url(#blueWaveGradParent)" />
                <path d="M 0,0 L 140,0 C 240,60 290,130 0,195 Z" fill="url(#blueWaveGradParent)" opacity="0.85" />
