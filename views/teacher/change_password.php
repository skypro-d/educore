<div class="auth-card">
    <div class="logo-area">
        <div class="logo-circle" style="background:#14b8a6;color:#fff;"><i class="ti ti-lock" style="font-size:28px;"></i></div>
        <h1>Update Your Password</h1>
        <p class="subtitle">For security reasons, you must change your temporary password before accessing the teacher portal dashboard.</p>
    </div>

    <form method="POST" action="<?= url('teacher/change-password') ?>">
        <?= csrf_field() ?>
    ...
    <div class="auth-footer">
        <p><a href="<?= url('teacher/logout') ?>">Sign Out</a></p>
    </div>
</div>
