<div class="auth-card">
    <div class="logo-area">
        ...
        <p class="subtitle">Reset your Staff / Teacher Portal access</p>
    </div>

    <p style="font-size:13px;color:#94a3b8;text-align:center;margin-bottom:24px;">
        Enter your Staff Username, Staff ID, or registered Staff Email to receive password recovery instructions.
    </p>

    <form method="POST" action="<?= url('teacher/reset-request') ?>">
        <?= csrf_field() ?>
        
        <div class="mb-4">
            <label class="form-label" for="identifier">Staff Username / ID / Email</label>
            <input class="form-control" type="text" name="identifier" id="identifier" required placeholder="e.g. STF-2026-0001 or staff@school.com" autofocus>
        </div>
    ...
    <div class="auth-footer">
        <p><a href="<?= url('teacher/login') ?>">&larr; Back to Staff Login</a></p>
