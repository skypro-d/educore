...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
    <div>
        <h1 class="h3 fw-bold text-dark mb-1"><i class="ti ti-calendar-time text-primary me-2"></i>My Class Timetable</h1>
        <p class="text-muted small mb-0">Official weekly lecture schedule and allocated subject teachers.</p>
    </div>
...
<div class="row g-4 mb-4">
    <?php foreach ($days as $day): ?>
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white" style="<?= $isToday ? 'border-top: 4px solid var(--student-primary, #0284c7) !important; background: #fafcff;' : '' ?>">
...
<style>
@media print {
    .st-sidebar, .st-mobile-bar, .btn, .breadcrumb, .powered-credit {
